    ...
    @IBInspectable var placeholderTextColor : UIColor? = UIColor.white{
        didSet{
          guard let pColor = placeholderTextColor, let strPlaceholder = placeholder else {
            ...
            attributedPlaceholder = NSAttributedString(string: strPlaceholder, attributes: [NSForegroundColorAttributeName : color]);
    ...
    override public var placeholder: String?{
        didSet{
          guard let pColor = placeholderTextColor, let strPlaceholder = placeholder else {
            ...
            attributedPlaceholder = NSAttributedString(string: strPlaceholder, attributes: [NSForegroundColorAttributeName : pColor]);
            tintColor = placeholderTextColor
        }
    }
