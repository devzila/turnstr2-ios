...
class Utility: NSObject {
    ...
    /*
     ...
     let scale: CGFloat = 1
     // We dont't use [[UIScreen mainScreen] scale] as we don't want the native pixel, we want pixels for UIFont - it does the retina scaling for us
     ...
     pixelPerInch = 163.0 * scale
     }
     else {
     pixelPerInch = 160.0 * scale
     }
