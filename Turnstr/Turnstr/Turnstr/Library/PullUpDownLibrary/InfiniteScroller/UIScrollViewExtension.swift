...
public extension UIScrollView {
    ...
    func addPullRefreshHandler(_ refreshCompletion: (() -> ())?) {
        self.addPullRefresh(refreshCompletion)
    }
    // Add push/ Infinite scroll handler on table view
    func addPushRefreshHandler(_ refreshCompletion: (() -> ())?) {
        self.addPushRefresh(refreshCompletion)
    }

    // Add pull to refresh
    fileprivate func addPullRefresh(_ refreshCompletion: RefreshCompletion?, options: PullToRefreshOption = PullToRefreshOption()) {
    ...
    fileprivate func addPushRefresh(_ refreshCompletion: RefreshCompletion?, options: PullToRefreshOption = PullToRefreshOption()) {
