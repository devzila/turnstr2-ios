...
class ASMyFollowersStoryVC: ParentViewController {
    ...
    override func viewDidLoad() {
        ...
        shortStoryCollection.register(headerNib, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "MyProfileReusableViewCollectionReusableView")
...
extension ASMyFollowersStoryVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "MyProfileReusableViewCollectionReusableView", for: indexPath) as? MyProfileReusableViewCollectionReusableView else { return UICollectionReusableView() }
        header.updateStory()
