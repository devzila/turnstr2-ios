...
class DefaultAudioDevice: NSObject {
    ...
    fileprivate func tearDownAudio() {
        ...
        do {
            try session.setCategory(AVAudioSession.Category(rawValue: previousAVAudioSessionCategory))
            try session.setMode(AVAudioSession.Mode(rawValue: avAudioSessionMode))
...
extension DefaultAudioDevice {
    ...
    fileprivate func setupAudioSession() {
        ...
        previousAVAudioSessionCategory = session.category.rawValue
        avAudioSessionMode = session.mode.rawValue
