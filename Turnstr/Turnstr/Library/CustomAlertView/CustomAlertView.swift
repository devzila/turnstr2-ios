...
class CustomAlertView: UIView {
    ...
    @objc func dismissClicked(sender: UIButton) -> Void {
        close()
    }
    ...
    private func setObservers() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(CustomAlertView.keyboardWillShow(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(CustomAlertView.keyboardWillHide(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
    ...
    private func addButtonsToView(container: UIView) {
        ...
        for buttonIndex in 0...(buttonTitles!.count - 1) {
            ...
            button.addTarget(self, action: #selector(CustomAlertView.buttonTouchUpInside(sender:)), for: UIControl.Event.touchUpInside)
            ...
            button.setTitle(buttonTitles![buttonIndex], for: UIControl.State.normal)
            button.setTitleColor(colorNormal, for: UIControl.State.normal)
    ...
    // Call the delegates
    @objc internal func buttonTouchUpInside(sender: UIButton!) {
    ...
    @objc internal func deviceOrientationDidChange(notification: NSNotification) {
